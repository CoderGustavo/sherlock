    ...
    return Container(
      ...
      child: Center(
        child: Column(
          children: [
            Image.asset(
              '../assets/SecureData.png', // Substitua pelo caminho da sua imagem
            ...
            Center(
              child: Padding(
                padding: EdgeInsets.all(5.0), // Adiciona padding de 5 em todos os lados
                child: Text(
                  'Adote técnicas de cibersegurança',
